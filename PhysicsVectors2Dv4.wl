...
$Assumptions={{x,y,r,\[Phi]}\[Element]Reals,r>0,-Pi<\[Phi]<Pi};

(*Vector addition*)
Vector2D/:Plus[v1_Vector2D,v2_Vector2D]:=Vector2D@@(List@@v1+List@@v2);

(*Dot products, must be defined before scalar multiplication to give it evaluation precedence*)
...
(*If people want to use OverHat and OverVector, these are necessary*)
Unprotect[OverHat,OverVector];
SetAttributes[OverHat,HoldAll];
SetAttributes[OverVector,HoldAll];
Protect[OverHat,OverVector];
